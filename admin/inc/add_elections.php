            ...
            <tbody>
                ...
                ?>
                            <tr>
                                ...
                                <td> 
                                <button class="btn btn-sm btn-primary" onclick="EditData(<?php echo $election_id; ?>)">Edit</button>
...
<script>
    const EditData = (e_id) => {
        // Redirect to the edit page with the election ID as a parameter
        // Modify the URL according to your application's structure
        location.assign("index.php?addElectionPage=1&edit_id=" + e_id);
    }
</script>
